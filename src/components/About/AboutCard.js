      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            <br />
            <FaAws style={{ fontSize: "30px" }} />{" "}
            <span className="purple"> AWS Certified </span> Cloud Practitioner{" "}
            <br />
            <br />
